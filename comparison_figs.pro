pro comparison_figs
  ...
  EWondisk_brown = read_csv('C:\Users\elovett\EuropaResearch\Paper 1\leblanc2005_EWondisk.csv')
  NSondisk_brown = read_csv('C:\Users\elovett\EuropaResearch\Paper 1\leblanc2005_NSondisk.csv')
...
; calculate g-value
  ...
  RESTORE, dir+'\Processed\0131_EWondisk_rayleighs.sav'
  EW1 = area_profile
;  RESTORE, dir+'\Processed\0132_EWondisk_rayleighs.sav'
;  EW2 = area_profile
;  RESTORE, dir+'\Processed\0162_EWondisk_rayleighs.sav'
;  EW3 = area_profile
...
;  cglegend, colors=['green', 'black'],psym=[2,1], titles=['LeBlanc et al. (2005)', 'Keck/HIRES'], length=0.01, symsize=0.1, /Box, Location=[0.15, 0.70], charsize=1.0, /Background, vspace=1
  ...
  plate_scale = 0.358
  yr = [-(suncol*plate_scale/ang_radius), ((n_elements(EW1)-suncol)*plate_scale/ang_radius)]
  ...
  cgplot, EWondisk_brown.field1, EWcolumn, psym=9, title='EW Comparison to LeBlanc et al. (2005)',ytitle='D1+D2 Emission (Rayleighs)', xtitle='Distance from Europa (Europa radii)', xr=[yr[0],yr[1]], color='dark red', /ynozero, thick=1.5
  cgplot, EWondisk_brown.field1, EW1, /overplot, color='black', psym=16, symsize=1.5, /ylog
...
;  cgplot, EWondisk_brown.field1, EW3, /overplot, color='black', psym=16, symsize=1.5
  cglegend, colors=['dark red', 'black'],psym=[9,16], titles=['LeBlanc et al. (2005)', 'Lovett et al. (in prep)'], length=0, symsize=1.5, /Box, Location=[0.15, 0.80], charsize=2.0, /Background, vspace=2
...
;  cglegend, colors=['green', 'black'],psym=[2,1], titles=['LeBlanc et al. (2005)', 'Keck/HIRES'], length=0.5, symsize=0.5, /Box, Location=[0.15, 0.70], charsize=2.0, /Background, vspace=1
  ...
  cgplot, NSondisk_brown.field1, NScolumn, psym=9, title='NS Comparison to LeBlanc et al. (2005)',ytitle='D1+D2 Emission (Rayleighs)', xtitle='Distance from Europa (Europa radii)', color='dark red', xr=[-20,20], /ynozero, thick=1.5
  cgplot, EWondisk_brown.field1, NS1, /overplot, color='black', psym=16, symsize=1.5
;  cgplot, EWondisk_brown.field1, NS2, /overplot, color='black', psym=16, symsize=1.5
;  cgplot, EWondisk_brown.field1, NS3, /overplot, color='black', psym=16, symsize=1.5
  cglegend, colors=['dark red', 'black'],psym=[9,16], titles=['LeBlanc et al. (2005)', 'Lovett et al. (in prep)'], length=0, symsize=1.5, /Box, Location=[0.15, 0.80], charsize=2.0, /Background, vspace=2
